    ...
    <aside class="sb-sidebar" [class.hidden-mobile]="!open()" aria-label="Primary navigation">
      ...
      <nav class="sb-nav custom-scrollbar" aria-label="Sections">
        <div>
          ...
          <a data-testid="nav-dashboard" routerLink="/dashboard" routerLinkActive="active" class="sb-nav-link"><svg lucideLayoutGrid style="width:16px;height:16px" /> <span style="flex:1">Dashboard</span></a>
          <a data-testid="nav-accounts" routerLink="/accounts" routerLinkActive="active" class="sb-nav-link"><svg lucideWallet style="width:16px;height:16px" /> <span style="flex:1">Accounts</span></a>
        </div>
        <div>
          <p class="micro-label sb-nav-group-label">Money</p>
          <a data-testid="nav-transfers" routerLink="/transfers" routerLinkActive="active" class="sb-nav-link"><svg lucideArrowUpRight style="width:16px;height:16px" /> <span style="flex:1">Transfers</span></a>
          <a data-testid="nav-cards" routerLink="/cards" routerLinkActive="active" class="sb-nav-link"><svg lucideCreditCard style="width:16px;height:16px" /> <span style="flex:1">Cards</span></a>
        </div>
        <div>
          <p class="micro-label sb-nav-group-label">System</p>
          <a data-testid="nav-settings" routerLink="/settings" routerLinkActive="active" class="sb-nav-link"><svg lucideSettings style="width:16px;height:16px" /> <span style="flex:1">Settings</span></a>
        </div>
      </nav>
